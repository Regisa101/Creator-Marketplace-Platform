...
export function RegisterBusiness() {
  ...
  const [data, setData] = useState({ email: '', full_name: '', password: '', confirmPassword: '', role: 'business' as const });
  ...
  return <AuthLayout role="business" mode="register" title="Create your Brand account">
    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="az-field"><label className="az-label">Email</label><input className="az-input" type="email" required value={data.email} onChange={(e) => setData(p => ({...p, email: e.target.value}))} placeholder="you@company.com" /></div>
